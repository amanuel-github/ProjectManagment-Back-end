...
namespace AuthServer.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, IIdentityServerInteractionService interaction, IAuthenticationSchemeProvider schemeProvider,
            IClientStore clientStore, IEventService events, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordModel forgotPasswordModel)
        {
            ...
            var message = "Reset password token" + callback;
